...
> {
  ...
  try {
    ...
    // gatewayChainId is optional in metadata, will be extracted from EIP712 domain if not present
    return {
      ...
      gatewayChainId: "gatewayChainId" in metadata && typeof metadata.gatewayChainId === "number"
